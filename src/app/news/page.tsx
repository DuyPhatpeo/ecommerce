    ...
    <div className="w-full bg-white">
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 py-5">
        <div className="flex items-center gap-2 text-xs text-gray-500 font-medium">
          ...
          <span>&gt;</span>
          <span className="text-primary font-semibold">Tin tức thể thao</span>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-gray-100">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-none pl-10 pr-4 py-2.5 text-xs text-gray-800 placeholder-gray-400 focus:outline-none focus:border-primary"
            />
          </div>
        </div>
            ...
            >
              <div>
                ...
                <div className="p-6">
                  ...
                  <h3 className="font-black text-base text-gray-900 leading-snug group-hover:text-primary transition-colors line-clamp-2 mb-3">
                    {item.title}
                  </h3>
              ...
              <div className="px-6 pb-6 pt-2 flex items-center justify-between text-xs text-gray-500 font-bold border-t border-gray-50">
                ...
                <span className="inline-flex items-center gap-1 text-black group-hover:text-primary transition-colors">
                  <span>Chi tiết</span>

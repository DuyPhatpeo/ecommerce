...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className="relative text-gray-300 py-30 px-4 sm:px-6 md:px-10 lg:px-16 bg-cover bg-center bg-no-repeat"
      style={{
            ...
            <form className="group">
              <div
                className="flex overflow-hidden rounded-lg border border-gray-700 
                            group-hover:border-[#ff9f00] transition-all duration-300 shadow-lg"
              >
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 min-w-0 px-3 sm:px-4 py-3 bg-[#2a2a2a]/60 text-white text-sm outline-none 
                           placeholder-gray-500 focus:bg-[#333333]/70 transition-colors"
                />
                <Button
                  type="submit"
                  icon={<Send size={16} />}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              {instaImages.map((src, index) => (
                <div
                  key={index}
                  className="relative w-full overflow-hidden rounded-md group cursor-pointer
                ...
                >
                  ...
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-[#ff9f00]/80 to-transparent 
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                { Icon: Dribbble, color: "hover:bg-[#ea4c89]" },
                {
                  Icon: Instagram,
                  color:
        ...
        <div className="mt-14 pt-8 border-t border-gray-800">
          <div className="max-w-7xl mx-auto text-center">
            <div className="text-xs sm:text-sm text-gray-400 flex flex-row items-center justify-center gap-1 flex-wrap">
              ...
              <a
                href="#"
                className="text-[#ff9f00] hover:text-[#ffb347] font-semibold transition-colors ml-1 

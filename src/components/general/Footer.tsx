    ...
    <footer className="bg-gradient-to-b from-[#1a1a1a] to-[#0d0d0d] text-gray-300 py-30   px-4 sm:px-6 md:px-10 lg:px-16">
          ...
          <form className="group">
            ...
            >
              <input
                ...
                className="flex-1 min-w-0 px-3 sm:px-4 py-3 bg-[#2a2a2a] text-white text-sm outline-none 
                         placeholder-gray-500 focus:bg-[#333333] transition-colors"
              />
              <Button
                type="submit"
                icon={<Send size={16} />}
      ...
      <div className="mt-14 pt-8 border-t border-gray-800">
        <div className="max-w-7xl mx-auto text-center">
          <div className="text-xs sm:text-sm text-gray-500 flex flex-row items-center justify-center gap-1 flex-wrap">

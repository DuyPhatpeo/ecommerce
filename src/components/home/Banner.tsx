    ...
    <section className="relative h-screen overflow-hidden text-white">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-right flex flex-col items-center lg:items-end">
            ...
            <div className="mt-8 lg:mt-10">
              <button className="bg-gradient-to-r from-orange-400 to-red-500 px-6 lg:px-8 py-3 lg:py-4 rounded-full shadow-2xl font-semibold hover:scale-105 hover:shadow-orange-500/50 active:scale-95 transition-all flex items-center gap-2 text-sm lg:text-base">
                <FiPlus size={20} />
                ADD TO BAG
              </button>
            </div>
      ...
      <div className="absolute bottom-28 lg:bottom-8 right-4 lg:right-8 flex gap-2 lg:gap-3 z-20">
        <button
          ...
          className="w-10 h-10 lg:w-12 lg:h-12 rounded-full border-2 border-white/40 flex items-center justify-center hover:border-white hover:bg-white/10 disabled:opacity-50 backdrop-blur-sm transition-all active:scale-90"
